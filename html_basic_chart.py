...
""")
        ...
        chart_list = chart_artists.main(from_day, to_day) # external chart
        ...
        for item in range(0,20):
            ...
            if chart_list[item][1] == "-":
                ...
                html_list =( '        <li><span style="color:red">' + chart_list[item][0] + 
                                    ...
                                    '.html">' + chart_list[item][1] + #' - ' + chart_list[item][2] +
                                    ' <img src="link.png" width="10" height="10"></a> (' + str(chart_list[item][2]) +
                                    ')</li>\n')
                                    
                html_list_bold = ('        <li><span style="color:red">' + chart_list[item][0] +  
                                         '</span><a href = "track_detail_' + detail_file_number + 
                                         '.html"><b>' + chart_list[item][1] + #' - ' + chart_list[item][2] + 
                                         '</b> <img src="link.png" width="10" height="10"></a> (' + str(chart_list[item][2]) +
                                         ')</li>\n')

                # html_detail.main(str(chart_list[item][1]),
                               # str(chart_list[item][2]),
                               # str(chart_list[item][3]),
                               # detail_file_number,
                               # days_back[chart_no],
            ...
            if item == 0:
                artisttitle = chart_list[item][1] #+ " - " + chart_list[item][2] 
